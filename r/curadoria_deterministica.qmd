...
- **Formatar contagens por categoria.** Uma linha de texto tipo `"Species: 62, Genus: 2, sem dado: 16"` a partir de uma coluna -- usado no resumo de diagnóstico em vez de imprimir a tabela crua do R.
