...
- **Renomear colunas de metadados.** Renomeia colunas brutas de metadado para os nomes semânticos usados pelo pipeline (`config$metadados$colunas`) e converte `Latitude`/`Longitude` de inteiro para grau decimal (÷1e6).
