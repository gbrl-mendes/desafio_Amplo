...
- **Resolver a raiz do repo e fixar o diretório de trabalho.** Funciona via `Rscript` ou de dentro do RStudio/Positron, e fixa `setwd(REPO_ROOT)` para que caminhos relativos (`data/example/...`) resolvam de forma consistente.
