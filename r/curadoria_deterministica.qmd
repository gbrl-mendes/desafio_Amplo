...
O bounding box declarado em `config$checagem_regional$area_bbox` é usado exatamente como está, sem margem automática. O script busca só o fato (quantos registros do GBIF existem na área); plausibilidade é julgamento de uma etapa posterior.
